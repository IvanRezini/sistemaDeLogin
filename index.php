                ...
                <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaLogin">
                    ...
                    <form action="#" method="post" role="form" class="p-2" id="formLogin">
                        <div class="form-group">
                            <input type="text" name="nomeUsuario" class="form-control" placeholder="Nome do usuario" required minlength="5">
                        </div>
                    ...
                    <form action="#" method="post" role="form" class="p-2" id="formSenha">
                        <div class="form-group">
                            <small class="text-muted">
                                Para gerar nova senha digite seu e-mail para receber instruçoes.
                            </small>
                        </div>
                        <div class="form-group">
